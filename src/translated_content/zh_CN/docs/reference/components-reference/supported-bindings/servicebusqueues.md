...
| `timeoutInSec`                    |     N    | Input/Output                                                                                                                                                        | Timeout for all invocations to the Azure Service Bus endpoint, in seconds. _Note that this option impacts network calls and it's unrelated to the TTL applies to messages_. Default: `"60"`                                                                                                                                   | `"60"`                                   |
