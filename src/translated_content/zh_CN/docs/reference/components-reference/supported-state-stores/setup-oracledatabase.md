...
2. Create a database schema for state data. Create a new user schema - for example called _dapr_ - for storing state data. Grant this user (schema) privileges for creating a table and storing data in the associated tablespace.
