...
Dapr supports the configuration of multiple, named, pub/sub components _per application_. Each pub/sub component has a name and this name is used when publishing a message topic. Read the [API reference]({{< ref pubsub_api.md >}}) for details on how to publish and subscribe to topics.
