...
Scope 是事件订阅需要创建或更新的资源的标识符。 The scope can be a subscription, a resource group, a top-level resource belonging to a resource provider namespace, or an Event Grid topic. 例如:
