...
在本快速入门中，你将运行一个 `order-processor` 微服务，该微服务利用配置 API。 该服务：
...
克隆[在Quickstarts存储库中提供的示例](https://github.com/dapr/quickstarts/tree/master/configuration)。
...
从 Quickstarts 克隆目录的根目录导航到 `order-processor` 目录。
...
- [Dapr CLI 和初始化环境](https://docs.dapr.io/getting-started).
- Java JDK 11（或更高版本）：
  - [Oracle JDK](https://www.oracle.com/technetwork/java/javase/downloads/index.html#JDK11)，或者
  - OpenJDK
...
观看此视频[demoing the Configuration API quickstart](https://youtu.be/EcE6IGuX9L8?t=94):
