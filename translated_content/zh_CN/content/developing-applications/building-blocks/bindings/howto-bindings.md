...
使用绑定，可以调用外部资源，而无需绑定到特定的 SDK 或库。 For a complete sample showing output bindings, try the [quickstart](https://github.com/dapr/quickstarts/tree/master/bindings) or [tutorial](https://github.com/dapr/quickstarts/tree/master/tutorials/bindings).
