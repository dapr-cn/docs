...
要设置 MySQL 状态储存，请创建一个类型为 `state.mysql`的组件。 See [this guide]({{< ref "howto-get-save-state.md#step-1-setup-a-state-store" >}}) on how to create and apply a state store configuration.
