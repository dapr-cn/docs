...
| consumerID        |    否     | Input/Output | The client ID used to connect to the MQTT broker. Defaults to the Dapr app ID.                                                                                                                                                                                                                | `"myMqttClientApp"`                                                                                |
| qos               |    否     | Input/Output | 表示消息的服务质量等级（QoS）， 默认值 0 Defaults to `0`.                                                                                                                                                                                                                                                      | `1`                                                                                                |
