...
| 字段                   | 必填 |                                                                                                                数据类型 | 详情                                                                                                             | 示例                                          |
| -------------------- |:--:| -------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| 客户端                  | 否  |                                     [*api.Config](https://pkg.go.dev/github.com/hashicorp/consul/api@v1.3.0#Config) | 配置客户端与 Consul 代理的连接。 如果留空，它将使用 sdk 默认值，在这种情况下这只是 `127.0.0.1:8500`                                              | `10.0.4.4:8500`                             |
...
| 标签                   | 否  |                                                                                                          `[]string` | 在注册服务服务时包含的额外标签                                                                                                | `- "dapr"`                                  |
