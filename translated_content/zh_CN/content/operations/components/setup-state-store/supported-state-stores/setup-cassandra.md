...
This installs Cassandra into the `cassandra` namespace by default. This installs Cassandra into the `cassandra` namespace by default. To interact with Cassandra, find the service with: `kubectl get svc -n cassandra`.
