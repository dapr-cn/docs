...
| ----------- |:--------:| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| development |    Y     | Output          | Tells the binding which APNs service to use. 设置为 `true` 以用于开发环境， `false` 用于生产环境。 设置为 `true` 以用于开发环境， `false` 用于生产环境。 Default: `"true"`                                                                                                                                                                                                                    | `"true"`           |
