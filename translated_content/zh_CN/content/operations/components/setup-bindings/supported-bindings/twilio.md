...
| 字段         | 必填 | 绑定支持 | 详情                                   | 示例               |
| ---------- |:--:| ---- | ------------------------------------ | ---------------- |
| toNumber   | 是  | 输出   | The target number to send the sms to | `"111-111-1111"` |
| fromNumber | 是  | 输出   | The sender phone number              | `"122-222-2222"` |
| accountSid | 是  | 输出   | The Twilio account SID               | `"account sid"`  |
| authToken  | 是  | 输出   | The Twilio auth token                | `"auth token"`   |
