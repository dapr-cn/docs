...
There are a number of variants that affect the CPU and memory consumption for each of the system components. These variants are shown in the table below. These variants are shown in the table below. These variants are shown in the table below.
