...
**App Identity** - Dapr 需要 Sentry 服务来生成 [SPIFFE](https://spiffe.io/) id 给所有应用，并且这个 id 会附加在 TLS 证书中。 The SPIFFE id is of the format: `**spiffe://\&#060;trustdomain&#062;/ns/\&#060;namespace\&#062;/\&#060;appid\&#062;**`.  对应的规范中，信任域，命名空间 和 app ID 会从 SPIFFE id 的 TLS 证书中提取出来。   这些值会对应上规范中相应的值.。 如果这三者都匹配，则进一步匹配更具体的策略。
