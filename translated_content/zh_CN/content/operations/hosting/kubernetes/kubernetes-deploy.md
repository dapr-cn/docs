...
Dapr 初始化默认开启 [mTLS]({{< ref "security-concept.md#sidecar-to-sidecar-communication" >}})。 你可以用下面的命令关闭:
...
- [如何操作：配置 状态存储 和 发布/订阅 消息代理]({{< ref "getting-started/tutorials/configure-state-pubsub.md" >}})
